...
<html>
	...
	image1.src="img/bagslide1.jpg"
	var image2=new Image()
	image2.src="img/bagslide2.jpg"
	var image3=new Image()
	image3.src="img/bagslide3.jpg"
	//-->
	</script>
    ...
    <body>
       ...
       <input type="submit" value="Search" style="width: 120px; height: 30px; font-weight:bolder"/>
            ...
            <img src="img/bagslide1.jpg" name="slide"  height="" width="">
	<script>
	<!--
	var step=1
	function slideit(){
	...
	//-->
        ...
        <div id ="right">
            <div class="rimg">
                <a href="<s:url action="shoulderact"/>" title="Shoulders"><img src="img/bags1.jpg" height="200" width="100%"/></a>   
            </div >
            <div class="limg">
                <a href="<s:url action="clutchesact"/>" title="Clutches"><img src="img/bags2.jpg" height="200" width="100%"/></a>   
            </div>
            <div class="rimg">
                <a href="<s:url action="allbagact"/>" title="All Products"><img src="img/allpro.jpg" height="200" width="100%"/></a>   
            </div >
            <div class="limg">
                <a href="<s:url action="walletact"/>" title="Wallets"><img src="img/bags3.jpg" height="200" width="100%"/></a>   
            </div>
