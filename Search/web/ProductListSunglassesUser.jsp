...
<td align="center">
 ...
 <!--       <div>
            ...
            <font size="7" face="Agency FB" ><b>
                <a href="SunglassesHome.jsp" title="Online Shopping" style="text-decoration: none; color:darkslategray" onMouseOver="this.style.cursor='hand';" > &nbsp;picSUNGLASS</a>
            </b></font>
            </td>
            </tr>
            </table>
        ...
        <div> <table  align="center" width="100%"> <tr> 
            <td class="lnav" width="20%" valign="top">
               <div class="PP">
                ...
                <div>
                    <a href="<s:url action="allproglassact"/>" title="All products"style="text-decoration: none">All Products</a>
                </div>
                <div class="PP"><h3>Search By Type</h3></div>
                <div>
                    <a href="<s:url action="aviatorsact"/>" title="New Lines"style="text-decoration: none">Aviators</a>
                </div>
                <div>
                    <a href="<s:url action="rimlessact"/>" title="New Lines"style="text-decoration: none">Rimless</a>
                </div>
                <div class="PP"><h3>Search By Gender</h3></div>
                <div>
                    <a href="<s:url action="maleglassact"/>" title="Male Watches"style="text-decoration: none">Male</a>
                </div>
                <div>
                    <a href="<s:url action="femaleglassact"/>" title="Female Watches"style="text-decoration: none">Female</a>
                </div>
                <div class="PP"><h3>Search By Brand</h3></div>
                <div>
                     <a href="<s:url action="raybanact"/>" title="Ray Ban" style="text-decoration: none">Ray-Ban</a>
                </div>
                <div>
                      <a href="<s:url action="tagact"/>" title="Tag Heuer" style="text-decoration: none">Tag Heuer</a>
                </div>
                <div>
                     <a href="<s:url action="playboyact"/>" title="PlayBoy" style="text-decoration: none">PlayBoy</a>
                </div>
                <div class="PP"><h3>Search By Price</h3></div>
                <div>
                    <a href="<s:url action="rate1gact"/>" style="text-decoration: none">Upto 5000</a>
                </div>
                <div>
                    <a href="<s:url action="rate2gact"/>" style="text-decoration: none">Above 5000</a>
                </div>
            </td>
