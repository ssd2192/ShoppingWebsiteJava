...
public class AddProductAction extends ActionSupport implements ServletRequestAware{
    String proid,catid,proname,prodesc,progender,protype;
    int proprice;
    File proimg;
    String s="";
    String filePath;
    ...
    public String execute() throws IOException{
        ...
        boolean b=AddProduct.add(proid,catid,proname,prodesc,proprice,p,progender,protype);
        if(b){
            s=SUCCESS;
        }
        else{
    ...
    public void validate(){
     ...
     if(getProid().equals("") || getProid()==null){
         ...
         addActionError("Product Alredy Exist");
     }
