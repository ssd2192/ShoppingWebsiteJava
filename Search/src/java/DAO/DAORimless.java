...
public class DAORimless {
     public List<UserListaccessories> fetch(){
try{
Connection conn=MyConnection.OpenConnection();
PreparedStatement stmt=conn.prepareStatement("select * from PRODUCTS where UPPER(TYPE)=UPPER('rimless') AND UPPER(CATEGORY)=UPPER('sunglass')");
