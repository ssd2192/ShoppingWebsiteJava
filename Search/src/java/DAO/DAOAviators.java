...
public class DAOAviators {
      public List<UserListaccessories> fetch(){
try{
Connection conn=MyConnection.OpenConnection();
PreparedStatement stmt=conn.prepareStatement("select * from PRODUCTS where UPPER(TYPE)=UPPER('Aviators') AND UPPER(CATEGORY)=UPPER('sunglass')");
