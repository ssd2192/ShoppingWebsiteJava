...
public class DAOGentsSungalss {
     public List<UserListaccessories> fetch(){
try{
Connection conn=MyConnection.OpenConnection();
PreparedStatement stmt=conn.prepareStatement("select * from PRODUCTS where UPPER(CATEGORY)=UPPER('sunglass') AND UPPER(GENDER)=UPPER('Male')");
