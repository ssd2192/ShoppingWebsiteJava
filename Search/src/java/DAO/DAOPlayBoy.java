...
public class DAOPlayBoy {
     public List<UserListaccessories> fetch(){
try{
Connection conn=MyConnection.OpenConnection();
PreparedStatement stmt=conn.prepareStatement("select * from PRODUCTS where UPPER(BRANDNAME)=UPPER('palyboy') AND UPPER(CATEGORY)=UPPER('sunglass')");
