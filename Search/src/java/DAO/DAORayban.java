...
public class DAORayban {
     public List<UserListaccessories> fetch(){
try{
Connection conn=MyConnection.OpenConnection();
PreparedStatement stmt=conn.prepareStatement("select * from PRODUCTS where UPPER(BRANDNAME)=UPPER('Rayban') AND UPPER(CATEGORY)=UPPER('sunglass')");
