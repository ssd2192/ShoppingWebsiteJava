    ...
    <body>
        ...
        <div>
            ...
            <font size="5" face="Agency FB">
               ...
               <a href="AdminLogin.jsp" title="Logout" style="text-decoration: none; color: black">logout</a>
            </font>
            </td>
            </tr></table>
            </center>
        ...
        <tr>
            ...
            <td align="center">  <font face="Agency FB"size="4">
                <a href="AdminPasswordChange.jsp" style="text-decoration: none; color: red"><b>Change Password</b></a>   </font>
            </td>
            <td align="center">  <font face="Agency FB"size="4">
                <a href="AddAdmin.jsp" style="text-decoration: none; color: white"><b>Add New Administrator</b></a>   </font>
            </td>
            <td align="center">  <font face="Agency FB"size="4">
                <a href="AddAdmin.jsp" style="text-decoration: none; color: white"><b>View Orders Placed</b></a>   </font>
            </td>        </tr>
        ...
        <div style="background-image: url(img/adminback.jpg);background-size: 100% 100%;background-repeat: no-repeat"><center>
         ...
         <s:form action="changepassword" enctype="multipart/form-data">
            ...
            <s:label value="Current Password" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="pas" cssStyle="width:300pt; height:20pt; font-size:15pt"/>
            <s:label value="New Password" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="newpas" cssStyle="width:300pt; height:20pt; font-size:15pt"/>
            <s:label value="Confirm Password" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="confirmpas" cssStyle="width:300pt; height:20pt; font-size:15pt"/>
            <s:submit value="Change Password" cssStyle="height:20pt; width:100pt; font-size:11pt"/>
         </s:form>   
            </center>
        <br/><br/><br/><br/>
        </div> 
