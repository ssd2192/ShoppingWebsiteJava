...
<html>
    ...
    <body>
       ...
       <img src="img/s1.jpg" name="slide"  height="" width="">
	<script>
	<!--
	var step=1
	function slideit(){
	...
	//-->
        ...
        <div id ="right">
            <div class="rimg">
                <a href="<s:url action="Gentsact"/>" title="Gents Watches"><img src="img/gents.jpg" height="200" width="100%"/></a>   
            </div >
            <div class="limg">
                <a href="<s:url action="Ladiesact"/>" title="Ladies Watches"><img src="img/ladies.jpg" height="200" width="100%"/></a>   
            </div>
            <div class="rimg">
                <a href="<s:url action="allprowatchact"/>" title="All Products"><img src="img/allpro.jpg" height="200" width="100%"/></a>   
            </div >
            <div class="limg">
                <a href="<s:url action="NewLinesact"/>" title="NewLines"><img src="img/newlines.jpg" height="200" width="100%"/></a>   
            </div>
