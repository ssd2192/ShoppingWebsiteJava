...
<td align="center">
        ...
        <div> 
        <table style="background-color: #E8E8E8 " bordercolor="silver" align="center" border="0.9" width="100%" style="background-color: "> 
        <tr> 
       
           
        <td valign="top" style="background-color: white"> 
            <div align="center" style="font-size: 17pt; font-family: Agency FB; height: 35px; background-color:#009933; color: white">
                Product Detail
            </div>
  ...
  <b> Type &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :</b><s:property value="TYPE"/><br/>       
        ...
        <td style="background-color: white" width="50%" valign="top">
            <div align="center" style="font-size: 17pt; font-family: Agency FB; background-color: #3366CC; color: white; height: 35px">
                 Shipping Address
            </div>
      ...
      <s:actionerror/>
            <s:form action="finalbuyact">
            <s:label value="Create Username" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="uname" cssStyle="width:300pt; height:20pt; font-size:15pt"/>    
            <s:label value="Email" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="cmail" cssStyle="width:300pt; height:20pt; font-size:15pt"/>
            <s:label value="Name" cssStyle="font-size:15pt; color:black"/>
            <s:textfield name="cname" cssStyle="width:300pt; height:20pt; font-size:15pt"/>
            <s:label value="Address" cssStyle="font-size:15pt; color:black"/>
            <s:textarea name="caddress" cssStyle="width:300pt; height:60pt; font-size:15pt"/>
            <s:iterator value="userlistlist"> 
            <s:hidden name="proid" value="%{PRODID}" />
            <s:hidden name="price" value="%{PRICE}"/>
            </s:iterator> 
            <s:submit type="image" src="img/continue.JPG"/> 
            </s:form>
